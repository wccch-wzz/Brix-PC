...
/**
 * @file server/crashAnalyzer.js - 崩溃日志分析模块（兼容入口）
 * @description 实际实现已拆分到 server/crash-analyzer/ 子目录。
 *   本文件仅为保持调用方 require('./crashAnalyzer') 路径不变而保留，
 *   直接转发导出，对外 API（CrashAnalyzer / CrashReason）完全不变。
 */

module.exports = require('./crash-analyzer');
